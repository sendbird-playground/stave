...
const coreCommandDefinitions: CommandPaletteCoreCommandDefinition[] = [
  ...
  },
  {
    ...
    title: "Open Settings: Composer Commands",
    description: "Jump to the composer command settings section.",
    group: "settings",
    icon: Settings,
    keywords: ["settings", "composer commands", "slash commands", "prompt commands"],
    build: (args) => ({
      id: "settings.open.slash-commands",
      title: "Open Settings: Composer Commands",
      subtitle: "Inspect provider-native command behavior in the composer.",
      group: "settings",
      icon: Settings,
      keywords: ["settings", "composer commands", "slash commands", "prompt commands"],
