...
const HEADER_LINKS = [
  ...
  {
    href: "https://github.com/OWNER/stave/releases",
    label: "Releases",
    external: true,
  },
];
          ...
          <div className="mx-auto max-w-screen-2xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-base leading-7 text-muted-foreground">
                Stave brings the most useful pieces of a modern coding
                assistant — model sessions, shells, tasks, and safety — into a
                single desktop surface.
              </p>
            </div>
        ...
        <section className="border-b border-border/70 bg-muted/30">
          <div className="mx-auto max-w-screen-2xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-base leading-7 text-muted-foreground">
                The docs are ordered like a product manual. Install first,
                learn the daily surfaces, then extend.
              </p>
            </div>
